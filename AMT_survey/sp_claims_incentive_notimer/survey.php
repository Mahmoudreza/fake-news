...
<ul style="list-style-type:circle">
  <li><P>In addition to the amount promised for the task, for each of your judgements which <font color="blue">CORRECTLY</font> match the actual status of the claims, we will pay you 5 cents as the bonus. 
    <br>For example, if you judge a claim to be <font color="green">‘Very likely to be true’</font>, or <font color="green">‘I can confirm it to be true’</font>, and the claim is actually <font color="green">true</font>, then you'll get 5 cents for the claim. <br>Similarly, to get the bonus, an actual <font color="red">false</font> claim should be judged by you as <font color="red">‘I can confirm it to be false’</font> or <font color="red">‘Very likely to be false’</font>.<br> Finally if you judgued the claim as <font color="green">‘Possibly true’</font>/<font color="red">‘Possibly false’</font> and the claim acctualy is mixture however <font color="green">possibly true</font>/<font color="red">possibly false</font> you will earn bonus.
</P></li>
