...
<p> The task consists of 50 claims, one per page. You need to give your judgment for all of them in order to complete the task. </p>
...
function finish($worker_id, $psid) {
    // $next_uri = sprintf("https://dkr1.ssisurveys.com/projects/end?rst=1&psid=%s&basic=96465", $psid);
    $test_url = "https://dkr1.ssisurveys.com/projects/end?rst=1&psid=$psid&basic=96465";
    header("Location: $test_url");
    // echo '<meta http-equiv="refresh" content="1; URL="+$test_url />';
    exit;
?>
...
<div class="well">
    <center>
        <h2>Thank you for solving our survey!</h2>
        <p class="lead">
        Please follow the link below to collect your remuneration:
        </p>
        <p class="lead">
            <a href = "https://dkr1.ssisurveys.com/projects/end?rst=1&psid=<?=$psid?>&basic=96465" target="_blank">https://dkr1.ssisurveys.com/projects/end?rst=1&psid=<?=$psid?>&basic=96465</a>
        </p>
    </center>
</div>
...
function finish_quota_full($psid) {
?>
...
<div class="well">
    <center>
        ...
        <p class="lead">
        Unfortunately, the survey quota is full.
        You cannot continue solving this survey.
        <br>
        <br>
        ...
        <p class="lead">
            ...
            <a href = "https://dkr1.ssisurveys.com/projects/end?rst=3&psid=<?=$psid?>" target="_blank">https://dkr1.ssisurveys.com/projects/end?rst=3&psid=<?=$psid?></a>
        </p>
    </center>
</div>
...
if ($page == 0) {
        $psid = get_default($_GET, "psid", " ");
        $pid = get_default($_GET, "pid", " ");
        save_survey_psid_pid($workerid, $psid, $pid);
}
...
if ($page == 0) {
    list($quota_full) = survey_check_quota_full($workerid);
    $psid = get_psid($workerid);
    // $psid = 1234;


    if ($quota_full > $num_workers_quota){
        finish_quota_full($psid);
    }
    ...
    if ($total_responses == count($set)+1) {
        ...
        // document.location.href = "https://dkr1.ssisurveys.com/projects/end?rst=1&psid="+$psid+"&basic=96465"
        finish($workerid, $total_responses); 
        // header("Lcoation:https://www.mpi-sws.org/");
        // exit;
