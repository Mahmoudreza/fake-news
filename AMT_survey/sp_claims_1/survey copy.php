...
<div id="mturk-intro" class="well">
    ...
    <br>
    <br>
    <!--Your task is to determine whether each tweet is leaning <b><i>pro-democratic</i></b> or <b><i>pro-republican</i></b> or <b><i>neutral</i></b>.-->
...
Your task is to judge each tweet and answer whether or not you find the tweet to be (i) <b><i> informative</b></i>, (ii) <b><i>interesting</b></i>, (iii) <b><i>credible</b></i>, and (iv) <b><i>factual</b></i>.
	...
	<!--If you definitely can not infer the leaning of the tweet even after following the urls in the tweet, only then please pick <b><i>cant say</i></b> option.-->
	<br>
	<br>
...
function judge($workerid, $page, $npages, $tweet_obj) {
    ...
    ?>
        ...
        <hr>
        <fieldset>
        <legend>Q1. Is the above tweet informative? </legend>
        ...
        if ($is_answered == 0){
            ...
            echo('<label class="radio">');
            echo('<input type="radio" name="a" id="a2" value="0" onClick="radio_btn_clicked(\'a2\')">');
            ...
            echo('<label class="radio">');
            if ($given_answer_a == 0){
                echo('<input type="radio" name="a" id="a2" value="0" checked disabled>');
            
            } else {
                echo('<input type="radio" name="a" id="a2" value="0" disabled>');
            }
            echo('<div id = "t2_text"> No </div>');
            echo('</label>');
            ...
            //<legend>Q2. Is the above tweet interesting? </legend>
            ...
            if ($is_answered == 0){
                ...
                echo('<label class="radio">');
                echo('<input type="radio" name="b" id="b2" value="0" onClick="radio_btn_clicked(\'b2\')">');
                echo('<div id = "t2_text"> No </div>');
                echo('</label>');
                ...
                echo('<label class="radio">');
                if ($given_answer_b == 0){
                    echo('<input type="radio" name="b" id="b2" value="0" checked disabled>');
                    
                } else {
                    echo('<input type="radio" name="b" id="b2" value="0" disabled>');
                }
                echo('<div id = "t2_text"> No </div>');
                echo('</label>');
...
function radio_btn_clicked(btn_id)
{
    ...
    if (btn_id == "a1" || btn_id == "a2")}// && (btn_id == "b1" || btn_id == "b2")){
    // if (btn_id == "a1" || btn_id == "a2"){
        document.getElementById("btn_submit").disabled = false;

    }
    
    //if (btn_id == "b1" || btn_id == "b2"){
        // if (btn_id == "a1" || btn_id == "a2"){
      //  document.getElementById("btn_submit").disabled = false;
