...
<div id="mturk-intro" class="well">
    ...
    <p>
In this survey, you will be shown 52 claims, which are spreading or have spread over social media. Please aassume that the claim is true and then judge which party either "Liberal" or "Conservative" would benefit.
<br>
...
function judge($workerid, $page, $npages, $tweet_obj) {
    ...
    ?>
        ...
        if ($is_answered == 0){
            ...
            echo('<legend>If the claim was to be true, which party would benefit?
                </legend>');
            ...
            echo('<legend>If the claim was to be true, which party would benefit? </legend>');
            echo('<label class="radio">');
            if ($given_answer_a == 1){
