...
<div id="mturk-intro" class="well">
    ...
    <p>
In this survey, you will be shown 62 claims, which are spreading or have spread over social media. We would like to evaluate the "truth value" of each claim based on your judgment. Your task is to read each claim and label it as either ‘True’, ‘Mostly True’, ‘Mixture’, ‘Mostly False’, or ‘False’. 
...
<p> The task consists of 62 claims, one per page. You need to give your judgment for all of them in order to complete the task. </p>
