...
<P>We show the countdown timer; please label the claims before the countdown will be 0. This means that your answer takes less than 15 seconds. However, if it takes more, don't worry, label the claim and continue. Thanks. </P>
</ul> 
...
function countdown() {
    ...
    if (seconds == 1) {
      ...
      temp.innerHTML = "Please answer the qeustion and go to the next page. Thanks.";
      return;
    }
