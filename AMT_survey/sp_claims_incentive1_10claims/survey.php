...
<ul style="list-style-type:circle">
  ...
  <li><P>If your judgment for each question <font color="blue">takes more than 15 seconds</font>, then there would not be any bonus, even if you answer the question correctly.</P></li>
...
<p> The task consists of 12 claims, one per page. You need to give your judgment for all of them in order to complete the task. </p>
